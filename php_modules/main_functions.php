<?php
	...
	function checkEligibility($blood_group){
		...
		if($blood_group == "A+"){
			...
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE a_positive>0 or a_negative>0 or o_positive>0 or o_negative>0';
		...
		elseif($blood_group == "A-"){
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE  a_negative>0 or o_negative>0';
		...
		elseif($blood_group == "B+"){
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE  b_positive>0 or b_negative>0 or o_positive>0 or o_negative>0';
		...
		elseif($blood_group == "B-"){
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE  b_negative>0 or o_negative>0';
		...
		elseif($blood_group == "O+"){
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE  o_positive>0 or o_negative>0';
		...
		elseif($blood_group == "O-"){
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE  o_negative>0';
		...
		elseif($blood_group == "AB-"){
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE  ab_negative>0 or a_negative>0 or b_negative>0 or o_negative>0';
			...
			$sql = 'SELECT hid,hos_name,a_positive,a_negative,b_positive,b_negative,o_positive,o_negative,ab_positive,ab_negative,address_line,state FROM `hospital` WHERE a_positive>0 or a_negative>0 or b_positive>0 or b_negative>0 or o_positive>0 or o_negative>0 or ab_positive>0 or ab_negative>0';
