...
require_once 'php_modules/main_functions.php';
	...
	if(!$login){
		...
		// if logged in then head over to index file
...
<body>
		...
		<div class="row">
			<div class="col-md-7">
				...
				<div class="banner bg-has" >
		        	<?php include 'php_modules/regHospitalBackground.php';?>
		        </div>
		
		        <!-- ------------------------- -->
				<!-- register as hospital form -->
				<!-- ------------------------- -->
			...
			<div class="col-md-5">
				<form>
					<div class="form-group">
						<span class="regHos">Register As Hospital</span>
					</div>
					<div class="form-group">
					    <label for="inputName">Hospital Name</label>
					    <input type="text" class="form-control" id="inputName" placeholder="Hospital Name">
				    ...
				    <div class="form-group">
					    ...
					    <input type="tel" class="form-control" id="inputPhone" pattern="[0-9]{10}" placeholder="Phone Number">
				    ...
				    <div class="form-row">
					    ...
					    <div class="form-group col-md-4">
						    ...
						    <select id="inputState" class="form-control">
							    <option selected>Choose...</optiion>
				  	...
				  	<button type="button" class="btn btn-block btn-primary reg-hos">Register <i class="fa "></i></button>
	...
	<footer class="text-center small tm-footer">
          <p class="mb-0">©2020 All Right Reserved | Developed with &#10084;&#65039; by Akash Modak
	...
	<!-- register hospital using ajax -->
	<script type="text/javascript" src="js/regHospital.js"></script>
